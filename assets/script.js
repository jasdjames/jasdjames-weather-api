...
function searchFunc(searchCity) {
    ...
    $.ajax({
        ...
        // $("#city1").append(cityArr2[0])
        // $("#city2").append(cityArr2[1])
        // $("#city3").append(cityArr2[2])
        // $("#city4").append(cityArr2[3])
        // $("#city5").append(cityArr2[4])
        if (cityArr2.length > 5) {
            ...
            // $("#city2").empty().append(cityArr2[1])
            // $("#city3").empty().append(cityArr2[2])
            // $("#city4").empty().append(cityArr2[3])
            // $("#city5").empty().append(cityArr2[4])
